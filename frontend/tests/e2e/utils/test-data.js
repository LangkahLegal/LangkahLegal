...
/** Generate a unique case description to avoid collisions in Bursa tests */
export function generateUniqueCaseDescription(prefix = "E2E Bursa") {
  const ts = Date.now();
  const rand = Math.random().toString(36).substring(2, 7);
...
export const CONSULTATION_FORM = {
  validDescription:
    "Saya memerlukan konsultasi terkait masalah hukum perdata tentang sengketa tanah warisan keluarga.",
