      ...
      >
        ...
        <div className="space-y-4 z-10 relative">
          ...
          <h2
            ...
            font-headline font-bold text-[#0e0c1e] 
            leading-[1.1] tracking-tight
            /* Mobile: max-w-xs (320px) agar memeluk judul, Desktop: max-w-lg (512px) agar memanjang */
          ...
          <p
            ...
            /* Mobile: max-w-xs (320px) agar rapi, Desktop: max-w-2xl (672px) agar memanjang */
          ...
          <div className="pt-4 lg:pt-2">
            <button
              onClick={onAction}
              className="
                bg-[#0e0c1e] text-white 
                px-10 py-4 
                rounded-full 
                font-bold text-sm lg:text-base
                hover:scale-105 transition-all 
                active:scale-95 
                shadow-lg shadow-[#0e0c1e]/20
                w-full sm:w-auto
              "
            >
              Coba Sekarang
