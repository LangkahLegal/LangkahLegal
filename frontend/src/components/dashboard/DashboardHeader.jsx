 ...
 * @param {string} avatarUrl - URL foto profil
 */
    ...
    <section className="sticky top-0 z-50 flex justify-between items-center w-full transition-all duration-300 px-6 py-4 lg:px-10 lg:py-6 border-b border-white/5 bg-[#0e0c1e]/40 backdrop-blur-md shadow-[0_15px_40px_-20px_rgba(255,255,255,0.1)]">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative group/avatar">
          ...
          {/* Status Indicator (Opsional, tapi manis untuk UI Dashboard) */}
      ...
      <div className="flex items-center gap-3">
        <button
          aria-label="Settings"
          className="bg-white/0 hover:bg-white/10 p-2 lg:p-3 rounded-full transition-all group active:scale-95 border border-white/0"
        >
          <MaterialIcon
            name="settings"
