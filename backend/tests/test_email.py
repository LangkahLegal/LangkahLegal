...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("staging", "https://staging-langkahlegal.vercel.app"),
    ],
)
def test_get_frontend_base_url_fallback(app_env, expected_url):
    settings = Settings(
        app_env=app_env,
        app_name="TestApp",
        frontend_url="",
...
def test_get_frontend_base_url_with_env_var():
    settings = Settings(
        app_env="production",
        app_name="TestApp",
        frontend_url="https://custom.langkahlegal.com/",
        cookie_domain="localhost",
        supabase_url="https://supabase.co",
        supabase_key="key",
        supabase_portofolio_bucket="port",
    ...
    with patch("services.email_service.get_settings", return_value=settings):
        assert get_frontend_base_url() == "https://custom.langkahlegal.com"
